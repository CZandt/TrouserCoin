...
namespace TrouserCoin
{
    class Blockchain
    {
        ...
        public Blockchain(int difficulty, decimal miningReward)
        {
            ...
            this.Chain.Add(CreateGenesisBlock()); // Adds the first special gensis block to the block chain
        ...
        public void addPendingTransaction(Transaction transaction)
        {
            ...
            {
                throw new Exception("There must be a succicient money in the wallet");
            }
